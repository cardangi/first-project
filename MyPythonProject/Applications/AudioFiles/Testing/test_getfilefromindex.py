...
class TestGetfilefromindex(TestCase):
    ...
    def test_second(self):
        self.assertEqual([], shared.getfilefromindex("1-5", ["file_01", "file_02", "file_03", "file_04", "file_05"]))

    def test_third(self):
        self.assertEqual([], shared.getfilefromindex("1-10", ["file_01", "file_02", "file_03", "file_04", "file_05"]))
    ...
    def test_seventh(self):
        self.assertEqual(["file_05"], shared.getfilefromindex("5, 6, 7, 8, 9, 10", ["file_01", "file_02", "file_03", "file_04", "file_05"]))
    ...
    def test_tenth(self):
        self.assertEqual(["file_01"], shared.getfilefromindex("1", ["file_01", "file_02", "file_03"]))

    def test_eleventh(self):
        self.assertEqual([], shared.getfilefromindex("6, 7, 8, 9, 10", ["file_01", "file_02", "file_03", "file_04", "file_05"]))
